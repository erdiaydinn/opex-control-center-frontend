...
if (!(Test-Path $BackendPython)) {
  throw "Kurulum bulunamadi. Once .\INSTALL_OPEX_INVENTORY_V24.ps1 calistirin."
}
if (!(Test-Path (Join-Path $ProjectRoot "node_modules"))) {
  throw "Frontend bagimliliklari bulunamadi. Once .\INSTALL_OPEX_INVENTORY_V24.ps1 calistirin."
}
...
Write-Host "OPEX Inventory V24 baslatildi." -ForegroundColor Green
