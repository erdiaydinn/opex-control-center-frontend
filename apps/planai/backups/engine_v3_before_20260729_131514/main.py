...
def generate_planogram_lite(req: GenerateRequest):
    # V1 had a second, incompatible allocator here. Depending on which frontend
    # button was used, rules were silently bypassed and only 500 SKUs were read.
    # Keep the endpoint for compatibility, but make the canonical engine the
    ...
    result["summary"]["mode"] = "CANONICAL_FAST_COMPAT"
    return result
