    ...
    <div className="page">
      ...
      <section className="grid cols-3" style={{ marginTop: 22 }}>
        ...
        <div className="card pad setup-status-card">
          <div className="section-eyebrow">ABC + GÖMÜLÜ CATALOG</div>
          ...
          <button className="btn ghost" onClick={() => setActive('storeDna')}>ABC yükle / catalog kontrolü</button>
        </div>
        <div className="card pad setup-status-card">
          <div className="section-eyebrow">PLANOGRAM HAZIRLIK</div>
          <h3>{readiness?.ready_for_planogram ? 'Üretime hazır' : 'Eksikler var'}</h3>
          <p className="muted">Store DNA + ABC + gömülü Catalog + Merge tamamlanmadan engine default layout’a düşmez.</p>
