...
function Live3D({ products, metrics }) {
  ...
  return <section className="page livePage">
    <div className="sectionHero"><div><small>CANLI 3D</small><h1>Digital Twin<span>.</span></h1><p>Real-time, intelligent warehouse visualization.</p><div className="microLegend"><span>✓ Gerçek zamanlı güncelleme</span><span>✦ AI destekli içgörüler</span><span>⚠ Kritik alan izleme</span><span>↗ Akıllı yönlendirme</span></div></div><div className="seg"><button className="on">3D View</button><button>2D Plan</button><button>Heatmap</button></div></div>
