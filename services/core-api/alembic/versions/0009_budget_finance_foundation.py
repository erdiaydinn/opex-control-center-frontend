...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id", "plan_id"],
            ["budget_plan.tenant_id", "budget_plan.id"],
            ondelete="RESTRICT",
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "tenant_id", "id", "fiscal_period_id", "cost_center_id", name="uq_budget_line_scope_key"
        ),
    )
    op.create_index(
        "ix_budget_line_scope", "budget_line", ["tenant_id", "cost_center_id", "fiscal_period_id"]
    )
