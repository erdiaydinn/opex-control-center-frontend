...
Revision ID: 0010_academy_audit_idempotency
Revises: 0009_academy_foundation
...
revision: str = "0010_academy_audit_idempotency"
down_revision: str | None = "0009_academy_foundation"
