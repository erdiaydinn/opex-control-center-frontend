...
class JarvisServiceSettings(BaseSettings):
    ...
    def validate_identity_boundary(self) -> JarvisServiceSettings:
        ...
        object.__setattr__(self, "assertion_audience", audience)
        object.__setattr__(self, "assertion_jwks_file", jwks_file)
        return self
...
def verify_jarvis_service_assertion(
    ...
    if (
        lifetime <= 0
        or lifetime > settings.assertion_max_lifetime_seconds
    ):
        raise InternalAssertionInvalid(
