...
async def get_completion_snapshot(
        ...
        await session.execute(
            text(
                ...
                LEFT JOIN academy_progress AS p
                 ...
                 AND p.content_version_id = lpi.content_version_id
    ...
    return {
        **dict(enrollment),
        "required_content_version_ids": list(required_versions),
        "incomplete_content_version_ids": list(incomplete_versions),
        "missing_required_quiz_ids": list(missing_quizzes),
