...
TENANT_ID = UUID("00000000-0000-0000-0000-00000000cc01")

MEMBERSHIP_ID = UUID("00000000-0000-0000-0000-00000000cc11")
...
def make_settings(
    ...
    jwks_path = tmp_path / "internal-jwks.json"
...
def test_valid_internal_assertion_contains_identity_only(
    ...
    verified = verify_internal_identity_assertion(
        sign(
            private_key,
            claims(),
        ),
    ...
    assert verified.membership_id == MEMBERSHIP_ID
...
def test_algorithm_downgrade_is_rejected(
    ...
    _, public_jwk = build_key_material()
...
def test_provider_claim_smuggling_is_rejected(
    ...
    payload["provider_id"] = "00000000-0000-0000-0000-00000000ffff"
...
def test_wrong_issuer_is_rejected(
    ...
    payload["iss"] = "attacker-identity-gateway"
