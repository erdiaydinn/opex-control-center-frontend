...
built from comparable BenchmarkRun objects on the same task set/environment and
carry a deterministic fingerprint over the measured runs, comparisons and
source evidence references.  Frontier engine registries can require one of
these attestations before activating an engine.
"""
