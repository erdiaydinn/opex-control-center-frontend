...
out-of-envelope actions require additional approval or fail closed. The module
only emits authorization evidence and an adapter for mission_execution; it does
