...
KPI_REGISTRY: dict[str, KpiDefinition] = {
    ...
    "nsfr": KpiDefinition(
        ...
        semantic_contract_id="ops.nsfr.semantic.v1",
    ...
    "pfr": KpiDefinition(
        ...
        semantic_contract_id="ops.pfr.semantic.v1",
    ...
    "refund": KpiDefinition(
        ...
        semantic_contract_id="ops.refund.semantic.v1",
        blocked_reason="column-level production schema and precedence mapping require explicit verification",
    ),
    "prep": KpiDefinition(
        metric="prep",
        ...
        semantic_contract_id="ops.prep.semantic.v1",
    ...
    "picking": KpiDefinition(
        ...
        semantic_contract_id="ops.picking.semantic.v1",
    ...
    "putaway": KpiDefinition(
        ...
        semantic_contract_id="ops.putaway.semantic.v1",
