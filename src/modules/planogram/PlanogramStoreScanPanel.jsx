...
function ScanGeometryPreview({ scan, t }) {
  ...
  const fixtureRows = Array.isArray(scan.recognized_fixtures) ? scan.recognized_fixtures : [];
...
export default function PlanogramStoreScanPanel({ locale, formatNumber, canCreate }) {
  const inputRef = useRef(null);
  const t = useMemo(() => (key, params) => translatePlanogramStoreScan(locale, key, params), [locale]);
